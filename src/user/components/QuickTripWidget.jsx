...
export default function QuickTripWidget({ setPage, setGeneratedItinerary }) {
  ...
  return (
    <div
      className="mx-5 md:mx-8 lg:mx-14 mb-10 rounded-3xl overflow-hidden"
      style={{
        background:
          "linear-gradient(135deg,#2C1F12 0%,#4a2c1a 60%,#8B5E3C 100%)",
      ...
      <div className="p-6 md:p-8">
        <div className="flex items-start justify-between mb-5">
          <div>
            ...
            <h2
              ...
              style={{ fontSize: "clamp(22px,3vw,32px)", fontWeight: 400 }}
            >
        ...
        <button
          ...
          style={{
            ...
            boxShadow: "0 8px 28px rgba(192,101,74,.4)",
  ...
  return (
    <div>
      <label
        ...
        style={{ color: "rgba(212,168,83,.7)", letterSpacing: ".1em" }}
      >
        {label}
      </label>
      <select
      ...
      >
        {options.map((o) => (
          <option
            key={o}
            value={o}
            style={{ background: "#2C1F12", color: "#fff" }}
          >
            {o}
          </option>
        ))}
