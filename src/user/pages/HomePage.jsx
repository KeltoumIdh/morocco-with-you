...
function SkeletonCard() {
  return (
    ...
    >
      <div
        className="h-[220px] shimmer"
        style={{
          background:
            "linear-gradient(90deg,var(--light-clay) 25%,var(--sand) 50%,var(--light-clay) 75%)",
          backgroundSize: "200% 100%",
        }}
      />
      <div className="p-4 space-y-2">
        <div
          className="h-3 rounded-full shimmer w-3/4"
          style={{ background: "var(--clay)" }}
        />
        <div
          className="h-3 rounded-full shimmer w-1/2"
          style={{ background: "var(--clay)" }}
        />
      </div>
    </div>
    ...
    <div className="page-enter">
      ...
      <section
        ...
        style={{
          minHeight: "72vh",
          background:
            "linear-gradient(160deg,#2C1F12 0%,#4a2c1a 40%,#8B5E3C 100%)",
        }}
      >
        <MoroccoMotif />
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 60% 50%,rgba(212,168,83,.12) 0%,transparent 70%)",
          }}
        />

        {/* Desktop floating card */}
        <div
          className="hidden lg:block absolute right-12 top-1/2 -translate-y-1/2 w-72 rounded-3xl p-6 z-10"
          style={{
          ...
          {(loading ? [{}, {}, {}] : experiences.slice(0, 3)).map((exp, i) => (
            ...
            >
              <div
                ...
                style={{ background: exp.gradient || "var(--light-clay)" }}
              />
              <div>
                {loading ? (
                  <div
        ...
        <div
          className="relative z-10 px-5 md:px-10 lg:px-14 flex flex-col justify-center"
          style={{ minHeight: "72vh", paddingTop: 64, paddingBottom: 48 }}
        >
          <p
            className="text-xs font-semibold uppercase tracking-widest mb-4"
            style={{ color: "var(--gold)", letterSpacing: ".18em" }}
          >
            Morocco With You
          </p>
          <h1
          ...
          >
            From Marrakech riads to Sahara sunsets — curated experiences, local
            experts, instant booking.
          </p>

          <div
            className="mt-8 flex flex-col sm:flex-row gap-2 max-w-xl search-glow rounded-2xl p-2"
            style={{
          ...
          >
            <div className="flex items-center gap-2 flex-1 px-3">
              ...
              <input
                ...
                onKeyDown={(e) =>
                  e.key === "Enter" &&
                  setPage("explore", { search: search.trim() })
                }
            ...
            <button
              onClick={() => setPage("explore", { search: search.trim() })}
          ...
          <div className="flex flex-wrap gap-2 mt-5">
            {DESTINATIONS.map((d) => (
              <button
                key={d}
                onClick={() => setPage("explore", { search: d })}
                className="chip"
                style={{
          ...
          {[...Array(2)].flatMap(() =>
            [
              ...
              <span
                ...
                style={{ color: "rgba(212,168,83,.6)", whiteSpace: "nowrap" }}
              >
                ✦ {t}
              </span>
            )),
        ...
        <div className="flex items-end justify-between mb-4">
          <div>
            <p
              ...
              style={{ color: "var(--terracotta)", letterSpacing: ".12em" }}
            >
              Discover more
            </p>
            <h2
          ...
          {[
            {
              label: "Activities",
              emoji: "🏄",
              gradient: "linear-gradient(135deg,#7A8C6E,#2C3828)",
              page: "activities",
            },
            {
              label: "Hébergement",
              emoji: "🏡",
              gradient: "linear-gradient(135deg,#D4A853,#8B5E3C)",
              page: "accommodations",
            },
            {
              label: "Restaurants",
              emoji: "🍽",
              gradient: "linear-gradient(135deg,#C0654A,#1A1410)",
              page: "restaurants",
            },
            {
              label: "Plan My Trip",
              emoji: "🗺",
              gradient: "linear-gradient(135deg,#6B8CAE,#1A2C38)",
              page: "planning",
            },
          ].map((v) => (
            <button
      ...
      <section className="px-5 md:px-8 lg:px-14 py-10 mb-4">
        <div
          className="rounded-3xl p-8 md:p-10 grid md:grid-cols-3 gap-6 md:gap-0"
          ...
          {[
            {
              icon: "✦",
              title: "Local Experts",
              desc: "Every experience is curated and led by certified local guides.",
            },
            {
              icon: "◈",
              title: "Instant Booking",
              desc: "Confirm your experience in seconds, no back-and-forth.",
            },
            {
              icon: "◇",
              title: "AI Trip Planner",
              desc: "Generate a full personalised itinerary in under a minute.",
            },
          ].map((f, i) => (
        ...
        <div className="pattern-bg relative rounded-3xl p-8 md:p-12 overflow-hidden text-center">
          ...
          <div className="relative z-10">
            ...
            <h2
              ...
              style={{ fontSize: "clamp(28px,4vw,44px)", fontWeight: 400 }}
            >
            ...
            >
              Tell us your dates, budget, and style. Our AI builds a day-by-day
              itinerary with the best local experiences.
            </p>
            <button
              onClick={() => setPage("ai")}
              className="ai-float inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-semibold text-sm"
              style={{
                background:
                  "linear-gradient(135deg,var(--terracotta),var(--deep))",
                color: "#fff",
